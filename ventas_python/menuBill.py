...
class CrudClients(ICrud):
    ...
    def create(self):
        ...
        gotoxy(2,7);print("Ingresa el numero de cedula:");dni = validar.cedula(32,7)  # Obtenido del decorador
    ...
    def update():
        ...
        while True:
            ...
            if 0 <= cliente_a_actualizar < len(clients):
                ...
                gotoxy(2, 26);print("Dni: "); nuevo_dni = validar.cedula(15,26)
